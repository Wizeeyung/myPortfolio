...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText('ogunbanwosamson@gmail.com');
    setCopied(true);
  }
  ...
  return (
    ...
    >
      ...
      <div className={cn(titleClassName, 'group-hover/bento:translate-x-2 transition duration-200 relative md:h-full min-h-40 flex flex-col px-5 p-5 lg:p-10')}>
        ...
        <div className={`${id=== 1 && 'lg:text-4xl max-w-[500px]'} font-sans font-bold  text-white text-lg lg:text-3xl max-w-96  z-10`}>
          {title}
        </div>
          ...
          {id === 6 && (
            <div className="mt-5 relative">
              ...
              <Magicbutton title={copied ? 'Email copied' : 'Copy my email'}
                icon={<IoCopyOutline />} position="left" otherClasses="!bg-[#161a31]"
